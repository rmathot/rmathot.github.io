...
Il en a aussi quelques moins bons : notamment, les commentaires non-modérés qui autorisent aussi un non-négligeable de personnes à laisser libre cours à leur rage devant leur écran (ou simplement à poster des trucs complètement hors-sujet). Comme dirait la reine consort Mathilde de Belgique, [_le cyber-harcèlement, c'est vraiment nul_](https://www.youtube.com/watch?v=6gs3uZD0DJU). Et une accumulation de message malveillants [a de l'impact <abbr title="away from keyboard">AFK</abbr>](https://fr.wikipedia.org/wiki/Cyberharc%C3%A8lement#Cons%C3%A9quence_pour_la_victime) sur celles et ceux qui les reçoivent.
